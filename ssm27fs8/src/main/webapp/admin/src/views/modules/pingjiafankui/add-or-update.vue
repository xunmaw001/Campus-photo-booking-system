  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fankuishijian" label="反馈时间" prop="fankuishijian">
              <el-input v-model="ruleForm.fankuishijian" 
                placeholder="反馈时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="反馈建议" prop="fankuijianyi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fankuijianyi" label="反馈建议" prop="fankuijianyi">
                    <span v-html="ruleForm.fankuijianyi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.fankuijianyi = this.ruleForm.fankuijianyi.replace(reg,'../../../ssm27fs8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
