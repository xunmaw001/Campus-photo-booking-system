<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="拍下时间" prop="paixiashijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.paixiashijian" 
                type="datetime"
                :readonly="ro.paixiashijian"
                placeholder="拍下时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.paixiashijian" label="拍下时间" prop="paixiashijian">
              <el-input v-model="ruleForm.paixiashijian" 
                placeholder="拍下时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.paixiashijian = this.getCurDateTime()
